...
View results of the position of : &nbsp;&nbsp;&nbsp; <select name="view_category">
						...
						<option>Academics Director</option>
						<option>Accommodation Director(Resident)</option>
						<option>Accommodation Director(Non-Resident)</option>
						<option>Catering Director</option>
						<option>Entertainment Director</option>
              </select>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
