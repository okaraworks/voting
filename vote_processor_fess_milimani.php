...
$username = getuserfield('username');
		...
		$congress_fess_vote_id = getvotedcongressfacultyofeducationandsocialsciencesdetails('vote_id');
		$congress_fess_id = getvotedcongressfacultyofeducationandsocialsciencesdetails('candidate_id');
		$congress_fess_reg_no = getvotedcongressfacultyofeducationandsocialsciencesdetails('reg_no');
		$congress_fess_id_no = getvotedcongressfacultyofeducationandsocialsciencesdetails('id_no');
		$congress_fess_first_name = getvotedcongressfacultyofeducationandsocialsciencesdetails('first_name');
		$congress_fess_sur_name = getvotedcongressfacultyofeducationandsocialsciencesdetails('sur_name');
		$congress_fess_position = getvotedcongressfacultyofeducationandsocialsciencesdetails('position');
		

if(isset($_SESSION['chairperson']) && isset($_SESSION['vice_chairperson']) && isset($_SESSION['secretary_general']) && isset($_SESSION['deputy_secretary_general']) && isset($_SESSION['finance_director']) && isset($_SESSION['academics_director']) && isset($_SESSION['accommodation_director_resident']) && isset($_SESSION['accommodation_director_nonresident']) && isset($_SESSION['catering_director']) && isset($_SESSION['entertainment_director']) && isset($_SESSION['congress_faculty_of_education_and_social_sciences']) && isset($_SESSION['congress_milimani'])) {
		...
		$congress_fess = $_SESSION['congress_faculty_of_education_and_social_sciences'];
	...
	$accommodation_director_nonresident) && !empty($catering_director) && !empty($entertainment_director) && !empty($congress_fess) && !empty($congress_milimani)) {
...
echo '<br>';			  
	  ...
	  echo "CONGRESS"."<br/>";
	  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
	  echo "Congress-Faculty of Education and Social Sciences : "."<font size=\"5\" color=\"blue\">".$congress_fess_first_name." ".$congress_fess_sur_name."</font>"."<br/>";
	  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";     
	  echo "Congress-Milimani :  "."<font size=\"5\" color=\"blue\">".$congress_milimani_first_name." ".$congress_milimani_sur_name."</font>"."<br/>"."<br/>";
