	...
	$accommodation_director_nonresident) && !empty($catering_director) && !empty($entertainment_director)) {
			 ...
			 $query_run = mysql_query($query);	
			  ...
			  if(mysql_num_rows($query_run) == 1){
				  ...
				  echo "Thank you ".$first_name." ".$sur_name." for excercising your democratic right."."<br />"."<br />";
				  echo "Your candidates of choice were : "."<br/>";
				  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				  echo "chairperson : ".$chairperson_first_name." ".$chairperson_sur_name."<br/>";
				  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				  echo "vice_chairperson : ".$vice_chairperson_first_name." ".$vice_chairperson_sur_name."<br/>";
				  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				  echo "secretary_general : ".$secretary_general_first_name." ".$secretary_general_sur_name."<br/>";
				  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				  echo "deputy_secretary_general : ".$deputy_secretary_general_first_name." ".$deputy_secretary_general_sur_name."<br/>";
				  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				  echo "finance_director :  ".$finance_director_first_name." ".$finance_director_sur_name."<br/>"; 
				  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				  echo "academics_director :  ".$academics_director_first_name." ".$academics_director_sur_name."<br/>"; 
				  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				  echo "accommodation_director_resident :  ".$accommodation_director_resident_first_name." ".$accommodation_director_resident_sur_name."<br/>";
				  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";     
				  echo "accommodation_director_nonresident :  ".$accommodation_director_nonresident_first_name." ".$accommodation_director_nonresident_sur_name."<br/>";
				  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"; 
				  echo "catering_director :  ".$catering_director_first_name." ".$catering_director_sur_name."<br/>"; 
				  echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
				  echo "entertainment_director :  ".$entertainment_director_first_name." ".$entertainment_director_sur_name."<br/>"."<br/>";
				  echo "You can now submit your choices or go back and edit them before submitting them.".".<br/>";
				  echo "</font>";
	 
			 
?>
</br></br></br>
<center><h2><p><a href="chairperson.php">edit choices</a> |
	  <a href="congress_check.php">submit vote</a></p>
