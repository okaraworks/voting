...
<?php		
			...
			?>		
				...
				<!--
				function confirmation() {
				var answer = alert("Voter has been successfully registered...")
			...
			?>		
				...
				<!--
				function confirmation() {
				var answer = alert("Sorry, voter could not be registered at this time. Please try again.")
				 }
				 //-->
				 </script> 
				</body>
...
<form action = "user_registration_admin_contd.php" method = "POST">
