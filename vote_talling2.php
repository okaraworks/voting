...
function individual_position_table() {
...
$password = getuserfield('password');
		...
		$congress_cdmha = $_SESSION['congress_cdmha'];
            ...
            if(isset($congress_fess)){
			$query_congress_fess = "INSERT INTO voted_congress_faculty_of_education_and_social_sciences
			(vote_id, candidate_id, reg_no, id_no, first_name, sur_name) 
			VALUES(NULL, '".mysql_real_escape_string($congress_fess_id)."', '".mysql_real_escape_string($congress_fess_reg_no)."', '".
			mysql_real_escape_string($congress_fess_id_no)."', '".mysql_real_escape_string($congress_fess_first_name)."', '".mysql_real_escape_string($congress_fess_sur_name)."')";			
			mysql_query($query_congress_fess);   
